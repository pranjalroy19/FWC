...
\raggedleft
\textbf{Name:} Pranjal Roy\\
\textbf{COMET ID:} COMETFWC062\\
\textbf{Date:} \today
\end{minipage}
...
\vspace{10pt}
\textbf{\Large INTRODUCTION TO TRIGONOMETRY}\\[6pt]
...
\begin{figure}[h]
\centering
\includegraphics[width=0.35\textwidth]{F4.png}
\caption*{Fig. 8.4}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.35\textwidth]{F5.png}
\caption*{Fig. 8.5}
\end{figure}
...
\[
\sin \angle A
= \frac{\text{side opposite to angle } A}{\text{hypotenuse}}
= \frac{BC}{AC}
\]
...
\vspace{10pt}
\textbf{Example 4 :} In a right triangle $ABC$, right-angled at $B$, if $\tan A = 1$, then verify that
\[
2 \sin A \cos A = 1.
\]
\begin{figure}[h]
\centering
\includegraphics[width=0.35\textwidth]{F6.png}
\caption*{Fig. 8.11}
\end{figure}


\textbf{Solution :} In $\triangle ABC$,
\[
\tan A = \frac{BC}{AB} = 1 \quad (\text{see Fig. 8.11})
\]
...
\vspace{10pt}
\textbf{Example 5 :} In $\triangle OPQ$, right-angled at $P$, $OP = 7$ cm and $OQ - PQ = 1$ cm (see Fig. 8.12). Determine the values of $\sin Q$ and $\cos Q$.

\begin{figure}[h]
\centering
\includegraphics[width=0.2\textwidth]{F7.png}
\caption*{Fig. 8.12}
\end{figure}

\textbf{Solution :} In $\triangle OPQ$, we have
...
\vspace{10pt}
\textbf{Example 6 :} In $\triangle ABC$, right-angled at $B$, $AB = 5$ cm and $\angle ACB = 30^\circ$ (see Fig. 8.19). Determine the lengths of the sides $BC$ and $AC$.
\begin{figure}[h]
\centering
\includegraphics[width=0.35\textwidth]{F8.png}
\caption*{Fig. 8.19}
\end{figure}

\textbf{Solution :}  To find the length of the side BC, we will
...
\[
AC = \sqrt{AB^2 + BC^2}
= \sqrt{5^2 + (5\sqrt{3})^2}\ \text{cm}
= 10 \text{ cm}.
\]

\vspace{10pt}
\textbf{Example 7 :} In $\triangle PQR$, right-angled at $Q$ (see Fig. 8.20), $PQ = 3$ cm and $PR = 6$ cm. Determine $\angle QPR$ and $\angle PRQ$.
\begin{figure}[h]
\centering
\includegraphics[width=0.4\textwidth]{F9.png}
\caption*{Fig. 8.20}
\end{figure}

\textbf{Solution :} Given $PQ = 3$ cm and $PR = 6$ cm.
Therefore,
\[
\frac{PQ}{PR} = \sin R
\]
