...
\vspace{10pt}
{\Large INTRODUCTION TO TRIGONOMETRY}\\[6pt]
...
choose the trigonometric ratio involving BC and the given side AB. Since BC is the side adjacent to angle C and AB is the side opposite to angle C, therefore $\frac{AB}{BC} = \tan C$
i.e.,
